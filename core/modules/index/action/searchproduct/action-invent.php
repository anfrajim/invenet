...
$cantidad = Almacen::getQYesF($product->id);
	...
	<tr class="<?php if($cantidad<=$product->cantidad_min){ echo "danger"; }?>">
		...
		<td style="width:250px;"><form method="post" action="index.php?view=adacarro">
...
<?php if($products_in_cero>0){ 
	echo "<p class='alert alert-warning'>Se omitieron <b>$products_in_cero productos</b> que no tienen existencias en el inventario. <a href='index.php?view=inventario'>Ir al Inventario</a></p>"; }?>
