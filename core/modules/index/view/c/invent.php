...
<a href="./index.php?view=cajahistorial" class="btn btn-default"><i class="fa fa-clock-o"></i> Historial</a>
<div class="btn-group">
...
<?php
$products = Factura::getByBoxId($_GET["id"]);
if(count($products)>0){
$total_total = 0;
?>
<br>
<table class="table table-bordered table-hover	">
	...
	<tr>
		<td style="width:30px;">
<a href="./index.php?view=unaventa&id=<?php echo $sell->id; ?>" class="btn btn-default btn-xs"><i class="fa fa-arrow-right"></i></a>			
