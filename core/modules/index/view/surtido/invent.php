...
<div class="row">
	...
	<p><b>Buscar producto por nombre o por codigo:</b></p>
		...
		<div class="row">
			<div class="col-md-6">
				<input type="hidden" name="view" value="surtido">
...
$cantidad= Almacen::getQYesF($product->id);
	?>
		<form method="post" action="index.php?view=adasurtido">
	<tr class="<?php if($cantidad<=$product->cantidad_min){ echo "danger"; }?>">
		<td style="width:80px;"><?php echo $product->id; ?></td>
		<td><?php echo $product->nombre; ?></td>
		<td><?php echo $product->ubicacion; ?></td>
		<td><b>$<?php echo $product->precio_en; ?></b></td>
		<td>
			<?php echo $cantidad; ?>
		</td>
		<td>
		<input type="hidden" name="articulo_id" value="<?php echo $product->id; ?>">
		<input type="number" class="form-control" required name="cantidad"  min="1" step="1" placeholder="Cantidad de producto ..."></td>
...
<tr >
	...
	<td><?php echo $product->ubicacion; ?></td>
	<td><?php echo $product->nombre; ?></td>
	<td><b>$ <?php echo number_format($product->precio_en); ?></b></td>
	<td><b>$ <?php  $pt = $product->precio_en*$p["cantidad"]; $total +=$pt; echo number_format($pt); ?></b></td>
	<td style="width:30px;"><a href="index.php?view=limpiarsurtido&articulo_id=<?php echo $product->id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>

<?php endforeach; ?>
</table>
<form method="post" class="form-horizontal" id="processsell" action="index.php?view=procesarsurtido">
<h2>Resumen</h2>
<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Proveedor</label>
    <div class="col-lg-10">
    <?php 
$clients = Entidad::getProviders();
    ?>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
		<a href="index.php?view=limpiarsurtido" class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
