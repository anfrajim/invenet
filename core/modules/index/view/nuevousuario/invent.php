<div class="row">
  ...
  <br>
    <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=adusuario" role="form">
...
<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Es Vendedor</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
...
<div class="checkbox">
    <label>
      <input type="checkbox" name="contador"> 
    </label>
  </div>
    </div>
  </div>
