...
<div class="row">
	<div class="col-md-12">
	<a href="index.php?view=surtidobyproduct" class="pull-right btn btn-lg btn-default	"> <i class="glyphicon glyphicon-chevron-left"></i> Regresar  </a>
	<h1><?php echo $product->nombre; ?> <small>Reportes</small></h1>
