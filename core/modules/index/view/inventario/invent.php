...
<br><table class="table table-bordered table-hover">
	...
	?>
	<tr class="<?php if($cantidad<=$product->cantidad_min/2){ echo "danger";}else if($cantidad<=$product->cantidad_min){ echo "warning";}?>">
		...
		<a href="index.php?view=historial&articulo_id=<?php echo $product->id; ?>" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-time"></i> Historial</a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
