...
<?php if(isset($_COOKIE['password_updated'])):?>
        ...
        <p><i></i> ¡La contraseña ha sido cambiada exitosamente!</p>
...
<br>	<form class="form-horizontal" id="changepasswd" method="post" action="index.php?view=cambiarcontra" role="form">
